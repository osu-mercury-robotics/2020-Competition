...
\item Operator – During the competition only the Operator may guide the robot. \CT{Note that the Operator is no longer required to be 50 miles (80km) away from the competition site. There will be a room provided at the competition venue for the Operator to guide the Robot. If the Operator is located on the OSU campus, her or she must control the Robot from the provided room. There is no other restriction on the location of the Operator} 
...
\begin{itemize}
\item A high-level block diagram of the robot \CT{including both electrical (batteries, sensors, relays, etc.) and mechanical systems (drive train, motors, belts, gears, etc.)}
...
\CT{\item Parts list/Bill of materials
