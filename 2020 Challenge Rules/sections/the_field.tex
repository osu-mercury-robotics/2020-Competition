...
\subsection{Object Identification and Handling}
	...
	\subsubsection{Drop-Off Zone}
		There will be one bright yellow bin at the drop-off zone. It will be dimensioned as \textbf{4 inches wide by 4 inches deep by 2 inches tall}. It will not have a front facing side. The robot is tasked with placing one cube in the \textbf{bright yellow} bin.
